...
})({"2Bqy8":[function(require,module,exports) {
...
let date = new Date();
let currentYear = (0, _momentDefault.default)().year();
let currentMonth = (0, _momentDefault.default)().month();
let firstDayOfMonth = (0, _momentDefault.default)().startOf(currentMonth);
let lastDateOfMonth = new Date(currentYear, currentMonth + 1, 0).getDate();
let lastDateOfPreviousMonth = (0, _momentDefault.default)().endOf(currentMonth - 1);
let lastDayOfMonth = (0, _momentDefault.default)().endOf(currentMonth);
const calendar = document.querySelector(".calendar");
const chooseDate = document.querySelector(".choose--date");
console.log((0, _momentDefault.default)().date());
console.log((0, _momentDefault.default)().endOf("November"));
console.log((0, _momentDefault.default)().startOf((0, _momentDefault.default)().month()));
...
const renderCalendar = function() {
    // Reassigning values
    firstDayOfMonth = (0, _momentDefault.default)().startOf(currentMonth);
    lastDateOfMonth = new Date(currentYear, currentMonth + 1, 0).getDate();
    lastDateOfPreviousMonth = (0, _momentDefault.default)().endOf(currentMonth - 1);
    lastDayOfMonth = (0, _momentDefault.default)().endOf(currentMonth);
    // Rendering the calendar
    let html = `
        <div class="current_year-month">
            <h2>${(0, _momentDefault.default)().format("MMMM")}, ${currentYear}</h2>
...
},{"../img/icon_arrow3.png":"cQhxs","@parcel/transformer-js/src/esmodule-helpers.js":"fd8tj","moment":"jwcsj","./objects":"kXREq"}],"cQhxs":[function(require,module,exports) {
module.exports = require("ef3fec99a734f203").getBundleURL("10Mjw") + "icon_arrow3.ac2a1826.png" + "?" + Date.now();

},{"ef3fec99a734f203":"c2l7x"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.29.4
...
},{}]},["2Bqy8","1SICI"], "1SICI", "parcelRequire0828")
